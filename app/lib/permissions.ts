...
export type CmsPermission = "hero" | "news" | "media" | "sponsors" | "settings" | "users" | "players" | "coaches" | "performance" | "achievements" | "games" | "gameday";
...
const rolePermissions: Record<CmsRole, CmsPermission[]> = {
  admin: ["hero", "news", "media", "sponsors", "settings", "users", "players", "coaches", "performance", "achievements", "games", "gameday"],
