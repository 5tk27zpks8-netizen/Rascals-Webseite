...
export type CmsPermission = "hero" | "news" | "media" | "sponsors" | "settings" | "users" | "players" | "coaches" | "achievements" | "games" | "gameday";
...
const rolePermissions: Record<CmsRole, CmsPermission[]> = {
  admin: ["hero", "news", "media", "sponsors", "settings", "users", "players", "coaches", "achievements", "games", "gameday"],
  editor: ["hero", "news", "media", "sponsors"],
  photographer: ["media"],
  coach: ["players", "coaches", "achievements", "games", "gameday", "media"],
