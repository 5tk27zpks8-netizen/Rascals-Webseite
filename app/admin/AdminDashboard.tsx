  ...
  return <AdminShell active="dashboard" title="Rascals OS" eyebrow="FOOTBALL & CLUB OPERATIONS">
    ...
    {!loading&&data&&<div className="dashboard-v2">
      ...
      <section className="dashboard-columns">
        <AdminCard><div className="cms-section-head"><div><small>FOOTBALL OPERATIONS</small><h2>Fünf zentrale Arbeitsbereiche</h2></div></div><div className="dashboard-quick-grid">
          ...
          <Quick href="/admin/playbook" icon="▤" title="Playbook & Scheme" text="Formations · Concepts · Plays · Assignments · Versions" />
