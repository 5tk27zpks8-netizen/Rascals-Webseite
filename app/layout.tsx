...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="de"><body><ImageFocusRuntime/><PublicAdminLogin />{children}</body></html>}
