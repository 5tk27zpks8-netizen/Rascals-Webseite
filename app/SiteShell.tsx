...
function JoinCta() {
  return <section className="join-cta"><img src="/team-entry-4k.webp" alt="" /><div className="hero-shade" /><div><span className="eyebrow">YOUR NEXT PLAY</span><h2>READY TO JOIN<br />THE <i>FAMILY?</i></h2><p>Du brauchst keine Erfahrung. Nur den Willen, Teil von etwas Größerem zu werden.</p><a className="button red" href="mailto:football@hsb1846.de">Probetraining anfragen <span>→</span></a></div></section>;
}
